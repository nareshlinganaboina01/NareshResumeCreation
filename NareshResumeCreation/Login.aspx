<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="NareshResumeCreation.Login" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Login - Naresh Resume Creation</title>
    ...
    <style>
        * {
        ...
        @media (max-width: 768px) {
            ...
            .error-message, .forgot-password-link, .login-link {
                font-size: 10px;
            }
            .header-section h1 {
                font-size: 18px;
    ...
    <script>
        ...
        function closeModal() {
            ...
            document.getElementById('<%= txtResetEmail.ClientID %>').value = '';
            document.getElementById('<%= lblResetMessage.ClientID %>').innerText = '';
        }
        ...
        <div class="welcome-section">
            <div class="main-content">
                ...
                <div class="login-container">
                    ...
                    <asp:Button ID="btnLogin" runat="server" Text="Login" CssClass="btn-login" OnClick="btnLogin_Click" CausesValidation="false" />
                    <asp:Label ID="lblLoginMessage" runat="server" CssClass="error-message"></asp:Label>
                    <div class="forgot-password-link">
                        <a href="#" onclick="openModal(); return false;">Forgot Password?</a>
                    </div>
        ...
        <div id="forgotPasswordModal" class="modal">
            <div class="modal-content">
                ...
                <div class="form-group">
                    ...
                    <div class="input-container">
                        <i class="fa fa-envelope"></i>
                        <asp:TextBox ID="txtResetEmail" runat="server" CssClass="input-field" Placeholder="Enter your email"></asp:TextBox>
                    </div>
                </div>
                <asp:Button ID="btnResetPassword" runat="server" Text="Send Reset Link" CssClass="btn-login" OnClick="btnResetPassword_Click" CausesValidation="false" />
